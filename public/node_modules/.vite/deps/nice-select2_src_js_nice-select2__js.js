...
import "C:/xampp/htdocs/Admin Test - Maghrib/node_modules/nice-select2/src/scss/nice-select2.scss";
...
NiceSelect.prototype.extractData = function() {
  ...
  options.forEach((item) => {
    if (item.tagName == "OPTGROUP") {
      ...
      if (item.dataset.display != void 0) {
...
export {
  bind,
  NiceSelect as default
};
//# sourceMappingURL=nice-select2_src_js_nice-select2__js.js.map
