...
var id = 0;
var Shuffle = class extends tinyEmitterExports {
  /**
   ...
   */
  _setColumns() {
    let containerWidth = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Shuffle.getSize(this.element).width;
