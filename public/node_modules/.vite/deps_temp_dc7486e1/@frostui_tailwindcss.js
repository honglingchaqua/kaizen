...
// node_modules/@frostui/tailwindcss/dist/frostui.mjs
var re = Object.defineProperty;
var oe = (e, i, t) => i in e ? re(e, i, { enumerable: true, configurable: true, writable: true, value: t }) : e[i] = t;
...
var St = {
  ...
  remove(e, i) {
    var t;
    return ((t = ht.get(e)) == null ? void 0 : t.delete(i)) || true;
  }
};
...
var I = class {
  ...
  destroy() {
    this._destroyed = true, this._element != null && St.remove(this.constructor.type, this._element);
  }
};
o(I, "type", "");
var Lt = {
  addAfterEvent(e, i, t) {
    const s = (n) => {
      i(n), e.removeEventListener(t, s, true);
    };
    e.addEventListener(t, s, true);
  },
  afterTransition(e, i) {
...
var S = class extends I {
  ...
  get isShown() {
    var t;
    return ((t = this._element) == null ? void 0 : t.classList.contains(S.DEFAULT.class.open)) ?? false;
  }
  show() {
...
var ce = async (e, i, t) => {
  ...
  for (let u = 0; u < r.length; u++) {
    ...
    f = y ?? f, c = b ?? c, g = { ...g, [L]: { ...g[L], ...D } }, k && E <= 50 && (E++, typeof k == "object" && (k.placement && (m = k.placement), k.rects && (h = k.rects === true ? await l.getElementRects({ reference: e, floating: i, strategy: n }) : k.rects), { x: f, y: c } = Ht(h, m, d)), u = -1);
  }
...
var fe = (e) => ({ name: "arrow", options: e, async fn(i) {
...
var pe = function(e) {
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(i) {
    var t;
    const { placement: s, middlewareData: n, rects: a, initialPlacement: l, platform: r, elements: d } = i, { mainAxis: h = true, crossAxis: f = true, fallbackPlacements: c, fallbackStrategy: m = "bestFit", fallbackAxisSideDirection: g = "none", flipAlignment: E = true, ...u } = e, L = st(s), w = st(l) === l, y = await (r.isRTL == null ? void 0 : r.isRTL(d.floating)), b = c || (w || !E ? [wt(l)] : function(A) {
      const R = wt(A);
      return [Dt(A), R, Dt(R)];
    }(l));
...
var ye = function(e) {
  return e === void 0 && (e = {}), { name: "shift", options: e, async fn(i) {
    const { x: t, y: s, placement: n } = i, { mainAxis: a = true, crossAxis: l = false, limiter: r = { fn: (L) => {
      let { x: w, y } = L;
      return { x: w, y };
...
function Mt(e) {
  return typeof ShadowRoot > "u" ? false : e instanceof U(e).ShadowRoot || e instanceof ShadowRoot;
}
function _t(e) {
...
function Pt(e, i, t) {
  ...
  if (i === "viewport")
    ...
    s = function(l, r) {
      const d = ft(l, true, r === "fixed"), h = d.top + l.clientTop, f = d.left + l.clientLeft, c = N(l) ? rt(l) : { x: 1, y: 1 };
...
function ve(e, i, t) {
  const s = N(i), n = K(i), a = ft(e, true, t === "fixed", i);
...
var Te = { getClippingRect: function(e) {
...
}, getClientRects: (e) => Array.from(e.getClientRects()), isRTL: (e) => $(e).direction === "rtl" };
var ie = (e, i, t) => {
...
var T = class extends I {
  constructor(t, s) {
    super(t, s);
    o(this, "_targetElement", null);
    o(this, "clicked", false);
    o(this, "_targetOffset", 4);
    o(this, "_placement", null);
    o(this, "_trigger", null);
    o(this, "_autoclose", null);
    o(this, "keyListener", (t2) => {
      t2.key == "Escape" && this.hide();
    });
    this.init();
  }
  get isShown() {
    var t;
    return ((t = this._targetElement) == null ? void 0 : t.classList.contains(T.DEFAULT.class.hidden)) === false;
  }
  get isHover() {
...
var x = class extends I {
  constructor(t, s) {
    super(t, s);
    o(this, "_targetElement", null);
    o(this, "_windowClickListen", false);
    o(this, "keyListener", (t2) => {
      t2.key == "Escape" && !this.isStatic && this.hide();
    });
    o(this, "onWindowClicked", (t2) => {
      !this.isStatic && t2.target instanceof HTMLElement && this._targetElement && this.isShown && (p.isElementContains(this._targetElement, t2.target) || this.hide());
    });
    this.init();
  }
  get isShown() {
  ...
  show() {
    if (this.dispatchEvent(x.EVENTS.show), this._targetElement != null && this._element != null) {
      ...
      document.body.style.paddingRight = Math.abs(window.innerWidth - t) + "px", document.body.classList.add(x.DEFAULT.class.overflowHidden), this._element.classList.add(x.DEFAULT.class.open), this._targetElement.classList.remove(x.DEFAULT.class.hidden), setTimeout(() => {
        this._targetElement.classList.add(x.DEFAULT.class.open), p.showOverlay(), this._windowClickListen || (window.addEventListener("click", this.onWindowClicked), this._windowClickListen = true);
      }, 1);
    }
  ...
  hide() {
    ...
    this.dispatchEvent(x.EVENTS.hide), this._targetElement != null && this.isShown && (document.body.classList.remove(x.DEFAULT.class.overflowHidden), (t = this._element) == null || t.classList.remove(x.DEFAULT.class.open), this._targetElement.classList.remove(x.DEFAULT.class.open), Object.assign(document.body.style, {
      ...
      window.removeEventListener("click", this.onWindowClicked), this._windowClickListen = false, p.hideOverlay(), this._targetElement.classList.add(x.DEFAULT.class.hidden);
...
var _ = class extends I {
  ...
  initOptions() {
    ...
    t ? this.config.scroll = t !== "false" : this.config.scroll == null && (this.config.scroll = false);
    let s = (l = this._element) == null ? void 0 : l.getAttribute(_.DEFAULT.attr.backdrop);
    s ? this.config.backdrop = s !== "false" : this.config.backdrop == null && (this.config.backdrop = true);
...
var bt = class {
  ...
  static retrieveFromLocal() {
    ...
    if (i == null)
      return this._state = this.defaultState, true;
    const t = JSON.parse(i);
    return Object.keys(t).forEach((s) => t[s] == null ? t[s] = this.defaultState[s] : void 0), this._state = t, true;
  }
...
var F = bt;
o(F, "_old_state", null), o(F, "_initialize", false), o(F, "stateKey", "frost.app_state"), o(F, "defaultState", { theme: "light" }), o(F, "_listener", []), o(F, "_state", bt.defaultState);
var et = class _et {
  static init() {
    F.attachListener(this.themeChangeListener), this.themeChangeListener(F.state);
  }
  static themeChangeListener(i) {
    i.theme == "system" ? (_et.changeTheme(window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", _et.windowThemeListener)) : (_et.changeTheme(i.theme), window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", _et.windowThemeListener));
  }
  static windowThemeListener(i) {
    _et.changeTheme(i.matches ? "dark" : "light");
  }
  static changeTheme(i) {
...
var it = class extends I {
  ...
  notifyThemeChanged(t) {
    ...
    if (this.trigger != "switch")
      ...
      t != "dark" ? (a.removeAttribute("checked"), a.checked = false) : (a.setAttribute("checked", "checked"), a.checked = true);
    }
  }
  init() {
...
//# sourceMappingURL=@frostui_tailwindcss.js.map
