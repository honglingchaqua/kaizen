    ...
    !function(t, e) {
      ...
      var t = function(t2) {
        return function(t3) {
          ...
          var i2 = Object.prototype.toString.call(t3);
          return "[object RegExp]" === i2 || "[object Date]" === i2 || function(t4) {
            return t4.$$typeof === e;
          }(t3);
        }(t2);
      };
      ...
      function i(t2, e2) {
        return false !== e2.clone && e2.isMergeableObject(t2) ? o((i2 = t2, Array.isArray(i2) ? [] : {}), t2, e2) : t2;
        var i2;
      }
      function s(t2, e2, s2) {
      ...
      function r(t2, e2, s2) {
        var r2 = {};
        return s2.isMergeableObject(t2) && a(t2).forEach(function(e3) {
          r2[e3] = i(t2[e3], s2);
        }), a(e2).forEach(function(a2) {
          (function(t3, e3) {
            return n(t3, e3) && !(Object.hasOwnProperty.call(t3, e3) && Object.propertyIsEnumerable.call(t3, e3));
          })(t2, a2) || (n(t2, a2) && s2.isMergeableObject(e2[a2]) ? r2[a2] = function(t3, e3) {
            if (!e3.customMerge)
              return o;
            var i2 = e3.customMerge(t3);
            return "function" == typeof i2 ? i2 : o;
          }(a2, s2)(t2[a2], e2[a2], s2) : r2[a2] = i(e2[a2], s2));
        }), r2;
      }
      var o = function(e2, a2, n2) {
        (n2 = n2 || {}).arrayMerge = n2.arrayMerge || s, n2.isMergeableObject = n2.isMergeableObject || t, n2.cloneUnlessOtherwiseSpecified = i;
        var o2 = Array.isArray(a2);
        return o2 === Array.isArray(e2) ? o2 ? n2.arrayMerge(e2, a2, n2) : r(e2, a2, n2) : i(a2, n2);
      }, h = function(t2) {
        return "object" == typeof t2 && void 0 !== t2.nodeType ? t2 : "string" == typeof t2 ? document.querySelector(t2) : null;
      }, l = function(t2, e2, i2, s2) {
        void 0 === s2 && (s2 = false);
        ...
        return void 0 === i2 && (i2 = false), i2 ? o(t2, e2) : Object.assign(t2, e2);
      };
      function p(t2, e2) {
        t2.prototype = Object.create(e2.prototype), t2.prototype.constructor = t2, d(t2, e2);
      }
      function d(t2, e2) {
        return d = Object.setPrototypeOf || function(t3, e3) {
          return t3.__proto__ = e3, t3;
        }, d(t2, e2);
      }
      var f = function() {
        function t2(t3, e3) {
          this.node = this.createElement(t3), e3 && this.set(e3);
        }
        var e2 = t2.prototype;
        ...
        return i2.setStyle = function(t3, e3) {
          var i3;
          "object" == typeof t3 ? u(this.style.current, t3) : u(this.style.current, ((i3 = {})[t3] = e3, i3));
          this.updateStyle();
        }, i2.updateStyle = function() {
          var t3 = {};
          u(t3, this.style.initial), u(t3, this.style.current), this.isHovered && u(t3, this.style.hover), this.isSelected && (u(t3, this.style.selected), this.isHovered && u(t3, this.style.selectedHover)), this.set(t3);
        }, e2;
      }(f), g = function(t2) {
        function e2(e3, i2) {
          return t2.call(this, "text", e3, i2) || this;
        }
        return p(e2, t2), e2.prototype.applyAttr = function(e3, i2) {
      ...
      }(f), b = {}, S = 1, w = { on: function(t2, e2, i2, s2) {
        void 0 === s2 && (s2 = {});
        var a2 = "jvm:" + e2 + "::" + S++;
      ...
      function x(t2, e2, i2) {
        var s2 = h(e2), a2 = -1 === s2.getAttribute("class").indexOf("jvm-region") ? "marker" : "region", n2 = "region" === a2 ? s2.getAttribute("data-code") : s2.getAttribute("data-index"), r2 = a2 + ":selected";
        return i2 && (r2 = a2 + ".tooltip:show"), { event: r2, type: a2, code: n2, element: "region" === a2 ? t2.regions[n2].element : t2.markers[n2].element, tooltipText: "region" === a2 ? t2.mapData.paths[n2].name || "" : t2.markers[n2].config.name || "" };
      }
      var k = function() {
        function t2() {
        }
        ...
        return e2.getLabelText = function(t3, e3) {
          ...
          return "function" == typeof e3.offsets ? e3.offsets(t3) : Array.isArray(e3.offsets) ? e3.offsets[t3] : [0, 0];
        ...
        function e2(e3) {
          var i2, s2 = e3.map, a2 = e3.code, n2 = e3.path, r2 = e3.style, o2 = e3.label, h2 = e3.labelStyle, l2 = e3.labelsGroup;
          (i2 = t2.call(this) || this).config = arguments[0], i2.canvas = s2.canvas, i2.map = s2, i2.shape = i2.canvas.createPath({ d: n2, dataCode: a2 }, r2), i2.shape.addClass("jvm-region jvm-element");
        ...
        return p(e2, t2), e2.prototype.updateLabelPosition = function() {
      ...
      var _ = function(t2) {
        function e2(e3) {
          var i2, s2 = e3.index, a2 = e3.map, n2 = e3.style, r2 = e3.x1, o2 = e3.y1, h2 = e3.x2, l2 = e3.y2, c2 = e3.group;
          return (i2 = t2.call(this) || this).shape = a2.canvas.createLine({ x1: r2, y1: o2, x2: h2, y2: l2, dataIndex: s2 }, n2, c2), i2.shape.addClass("jvm-line"), i2;
        }
        return p(e2, t2), e2;
      }(k);
      function j(t2, e2) {
      ...
      var C = function(t2) {
        function e2(e3) {
          var i3, s2 = e3.index, a2 = e3.style, n2 = e3.label, r2 = e3.cx, o2 = e3.cy, h2 = e3.map, l2 = e3.group;
          return (i3 = t2.call(this) || this)._map = h2, i3._isImage = !!a2.initial.image, i3.config = arguments[0], i3.shape = h2.canvas[i3._isImage ? "createImage" : "createCircle"]({ dataIndex: s2, cx: r2, cy: o2 }, i3._getStyle(), l2), i3.shape.addClass("jvm-marker jvm-element"), i3._isImage && i3.updateLabelPosition(), n2 && i3._createLabel(i3.config), i3;
        }
        p(e2, t2);
        var i2 = e2.prototype;
        return i2.updateLabelPosition = function() {
          ...
          var e3 = t3.index, i3 = t3.map, s2 = t3.label, a2 = t3.labelsGroup, n2 = t3.cx, r2 = t3.cy, o2 = t3.marker, h2 = t3.isRecentlyCreated, l2 = this.getLabelText(e3, s2);
      ...
      var X = function() {
        ...
        return t2.prototype.render = function() {
          var t3, e2, i2, s2, a2 = this._series.scale.getTicks(), n2 = l("div", "jvm-legend-inner");
          if (this._body.innderHTML = "", this._options.title) {
            var r2 = l("div", "jvm-legend-title", this._options.title);
            this._body.appendChild(r2);
          }
          this._body.appendChild(n2);
          for (var o2 = 0; o2 < a2.length; o2++) {
            switch (t3 = l("div", "jvm-legend-tick"), e2 = l("div", "jvm-legend-tick-sample"), this._series.config.attribute) {
              case "fill":
                s2 = a2[o2].value, /\.(jpg|gif|png)$/.test(s2) ? e2.style.background = "url(" + a2[o2].value + ")" : e2.style.background = a2[o2].value;
                break;
              case "stroke":
                e2.style.background = a2[o2].value;
                break;
              case "image":
                e2.style.background = "url(" + ("object" == typeof a2[o2].value ? a2[o2].value.url : a2[o2].value) + ") no-repeat center center", e2.style.backgroundSize = "cover";
            }
            t3.appendChild(e2), i2 = a2[o2].label, this._options.labelRender && (i2 = this._options.labelRender(i2));
            var h2 = l("div", "jvm-legend-tick-text", i2);
            t3.appendChild(h2), n2.appendChild(t3);
          }
        }, t2;
      }(), E = function() {
        function t2(t3) {
        ...
        function t2(t3, e3, i2) {
          void 0 === t3 && (t3 = {}), this._map = i2, this._elements = e3, this._values = t3.values || {}, this.config = t3, this.config.attribute = t3.attribute || "fill", t3.attributes && this.setAttributes(t3.attributes), "object" == typeof t3.scale && (this.scale = new E(t3.scale)), this.config.legend && (this.legend = new X(u({ map: this._map, series: this }, this.config.legend))), this.setValues(this._values);
        }
        var e2 = t2.prototype;
      ...
      var A = { handleContainerEvents: function() {
        var t2, e2, i2 = this, s2 = false, a2 = this;
        this.params.draggable && (w.on(this.container, "mousemove", function(n2) {
          if (!s2)
            return false;
          a2.transX -= (t2 - n2.pageX) / a2.scale, a2.transY -= (e2 - n2.pageY) / a2.scale, a2.applyTransform(), t2 = n2.pageX, e2 = n2.pageY, i2.isBeingDragged = true;
        }), w.on(this.container, "mousedown", function(i3) {
          return s2 = true, t2 = i3.pageX, e2 = i3.pageY, false;
        }), w.on(h("body"), "mouseup", function() {
          s2 = false;
        })), this.params.zoomOnScroll && w.on(this.container, "wheel", function(t3) {
          var e3 = 0;
          e3 = (t3.deltaY || -t3.wheelDelta || t3.detail) >> 10 || 1, e3 *= 75;
          var s3 = i2.container.getBoundingClientRect(), n2 = t3.pageX - s3.left - window.pageXOffset, r2 = t3.pageY - s3.top - window.pageYOffset, o2 = Math.pow(1 + a2.params.zoomOnScrollSpeed / 1e3, -1.5 * e3);
          a2.tooltip && a2.tooltip.hide(), a2.setScale(a2.scale * o2, n2, r2), t3.preventDefault();
        });
      }, handleElementEvents: function() {
        var t2 = this, e2 = this, i2 = this.container;
        w.delegate(i2, "mousedown", ".jvm-element", function() {
          t2.isBeingDragged = false;
        }), w.delegate(i2, "mouseover mouseout", ".jvm-element", function(t3) {
          var i3 = x(e2, this, true), s2 = e2.params.showTooltip;
          "mouseover" === t3.type ? t3.defaultPrevented || (i3.element.hover(true), s2 && (e2.tooltip.text(i3.tooltipText), e2.tooltip.show(), e2.emit(i3.event, [e2.tooltip, i3.code]))) : (i3.element.hover(false), s2 && e2.tooltip.hide());
        }), w.delegate(i2, "mouseup", ".jvm-element", function(t3) {
          var i3 = x(e2, this);
          if (!e2.isBeingDragged && !t3.defaultPrevented && ("region" === i3.type && e2.params.regionsSelectable || "marker" === i3.type && e2.params.markersSelectable)) {
            var s2 = i3.element;
            e2.params[i3.type + "sSelectableOne"] && e2.clearSelected(i3.type + "s"), i3.element.isSelected ? s2.select(false) : s2.select(true), e2.emit(i3.event, [i3.code, s2.isSelected, e2.getSelected(i3.type + "s")]);
          }
        });
      }, handleZoomButtons: function() {
        var t2 = this, e2 = this, i2 = l("div", "jvm-zoom-btn jvm-zoomin", "&#43;", true), s2 = l("div", "jvm-zoom-btn jvm-zoomout", "&#x2212", true);
        this.container.appendChild(i2), this.container.appendChild(s2), w.on(i2, "click", function() {
          t2.setScale(e2.scale * e2.params.zoomStep, e2.width / 2, e2.height / 2, false, e2.params.zoomAnimate);
        }), w.on(s2, "click", function() {
          t2.setScale(e2.scale / e2.params.zoomStep, e2.width / 2, e2.height / 2, false, e2.params.zoomAnimate);
        });
        ...
        var t2, e2, i2, s2, a2, n2, r2, o2 = this, h2 = function(h3) {
          ...
          if ("touchstart" == h3.type && (r2 = 0), 1 == d2.length)
            1 == r2 && (u2 = o2.transX, p2 = o2.transY, o2.transX -= (i2 - d2[0].pageX) / o2.scale, o2.transY -= (s2 - d2[0].pageY) / o2.scale, o2.tooltip.hide(), o2.applyTransform(), u2 == o2.transX && p2 == o2.transY || h3.preventDefault()), i2 = d2[0].pageX, s2 = d2[0].pageY;
          else if (2 == d2.length)
            if (2 == r2)
              c2 = Math.sqrt(Math.pow(d2[0].pageX - d2[1].pageX, 2) + Math.pow(d2[0].pageY - d2[1].pageY, 2)) / e2, o2.setScale(t2 * c2, a2, n2), o2.tooltip.hide(), h3.preventDefault();
            else {
        ...
        for (t2 in this.regionLabelsGroup = this.regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths)
          e2 = new M({ map: this, code: t2, path: this.mapData.paths[t2].path, style: u({}, this.params.regionStyle), labelStyle: this.params.regionLabelStyle, labelsGroup: this.regionLabelsGroup, label: this.params.labels && this.params.labels.regions }), this.regions[t2] = { config: this.mapData.paths[t2], element: e2 };
      }, createLines: function(t2, e2, i2) {
        var s2 = this;
        void 0 === i2 && (i2 = false);
        var a2, n2 = false, r2 = false;
        for (var o2 in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t2) {
          var h2 = t2[o2];
          for (var l2 in e2) {
            var c2 = i2 ? e2[l2].config : e2[l2];
            c2.name === h2.from && (n2 = this.getMarkerPosition(c2)), c2.name === h2.to && (r2 = this.getMarkerPosition(c2));
          }
          false !== n2 && false !== r2 && (a2 = new _({ index: o2, map: this, style: u({ initial: this.params.lineStyle }, { initial: h2.style || {} }, true), x1: n2.x, y1: n2.y, x2: r2.x, y2: r2.y, group: this.linesGroup }), i2 && Object.keys(this.lines).forEach(function(e3) {
        ...
        for (var o2 in void 0 === t2 && (t2 = {}), void 0 === e2 && (e2 = false), this.markersGroup = this.markersGroup || this.canvas.createGroup("jvm-markers-group"), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t2) {
          if (i2 = t2[o2], a2 = this.getMarkerPosition(i2), n2 = i2.coords.join(":"), e2) {
            if (Object.keys(this.markers).filter(function(t3) {
              return r2.markers[t3]._uid === n2;
            }).length)
              continue;
            o2 = Object.keys(this.markers).length;
          }
          false !== a2 && (s2 = new C({ index: o2, map: this, style: u(this.params.markerStyle, { initial: i2.style || {} }, true), label: this.params.labels && this.params.labels.markers, labelsGroup: this.markerLabelsGroup, cx: a2.x, cy: a2.y, group: this.markersGroup, marker: i2, isRecentlyCreated: e2 }), this.markers[o2] && this.removeMarkers([o2]), this.markers[o2] = { _uid: n2, config: i2, element: s2 });
        }
      }, createSeries: function() {
        for (var t2 in this.series = { markers: [], regions: [] }, this.params.series)
          for (var e2 = 0; e2 < this.params.series[t2].length; e2++)
            this.series[t2][e2] = new Y(this.params.series[t2][e2], this[t2], this);
        ...
        if (t2.coords) {
          ...
          return this.setScale(t2.scale * this.baseScale, n2, r2, true, t2.animate);
        }
      }, resize: function() {
        ...
        t2 > this.params.zoomMax * this.baseScale ? t2 = this.params.zoomMax * this.baseScale : t2 < this.params.zoomMin * this.baseScale && (t2 = this.params.zoomMin * this.baseScale), void 0 !== e2 && void 0 !== i2 && (n2 = t2 / this.scale, s2 ? (d2 = e2 + this.defaultWidth * (this.width / (this.defaultWidth * t2)) / 2, f2 = i2 + this.defaultHeight * (this.height / (this.defaultHeight * t2)) / 2) : (d2 = this.transX - (n2 - 1) / t2 * e2, f2 = this.transY - (n2 - 1) / t2 * i2)), a2 && v2 > 0 ? (o2 = this.scale, h2 = (t2 - o2) / v2, l2 = this.transX * this.scale, u2 = this.transY * this.scale, c2 = (d2 * t2 - l2) / v2, p2 = (f2 * t2 - u2) / v2, r2 = setInterval(function() {
          g2 += 1, m2.scale = o2 + h2 * g2, m2.transX = (l2 + c2 * g2) / m2.scale, m2.transY = (u2 + p2 * g2) / m2.scale, m2.applyTransform(), g2 == v2 && (clearInterval(r2), m2.emit("viewport:changed", [m2.scale, m2.transX, m2.transY]));
        ...
        var i2, s2, a2, n2 = D.maps[this.params.map].projection, r2 = n2.centralMeridian;
        return i2 = O[n2.type](t2, e2, r2), !!(s2 = this.getInsetForPoint(i2.x, i2.y)) && (a2 = s2.bbox, i2.x = (i2.x - a2[0].x) / (a2[1].x - a2[0].x) * s2.width * this.scale, i2.y = (i2.y - a2[0].y) / (a2[1].y - a2[0].y) * s2.height * this.scale, { x: i2.x + this.transX * this.scale + s2.left * this.scale, y: i2.y + this.transY * this.scale + s2.top * this.scale });
      }, getInsetForPoint: function(t2, e2) {
        var i2, s2, a2 = D.maps[this.params.map].insets;
        for (i2 = 0; i2 < a2.length; i2++)
          if (t2 > (s2 = a2[i2].bbox)[0].x && t2 < s2[1].x && e2 > s2[0].y && e2 < s2[1].y)
            return a2[i2];
      }, getMarkerPosition: function(t2) {
        var e2 = t2.coords;
        return D.maps[this.params.map].projection ? this.coordsToPoint.apply(this, e2) : { x: e2[0] * this.scale + this.transX * this.scale, y: e2[1] * this.scale + this.transY * this.scale };
        ...
        "object" == typeof t2 && (this.dataVisualization = new L(t2, this));
      } }, T = { onViewportChange: "viewport:changed", onRegionSelected: "region:selected", onMarkerSelected: "marker:selected", onRegionTooltipShow: "region.tooltip:show", onMarkerTooltipShow: "marker.tooltip:show", onLoaded: "map:loaded", onDestroyed: "map:destroyed" }, z = function() {
        function t2(t3) {
          var e3 = l("div", "jvm-tooltip");
          return this._map = t3, this._tooltip = document.body.appendChild(e3), this._bindEventListeners(), this;
        }
        var e2 = t2.prototype;
        return e2._bindEventListeners = function() {
          var t3 = this;
          w.on(this._map.container, "mousemove", function(e3) {
            if (t3._tooltip.classList.contains("active")) {
              var i2, s2, a2 = (i2 = t3._map.container, s2 = "#jvm-regions-group", Element.prototype.querySelector.call(i2, s2)).getBoundingClientRect(), n2 = t3._tooltip.getBoundingClientRect(), r2 = n2.height, o2 = n2.width, h2 = e3.clientY <= a2.top + r2 + 5, l2 = e3.pageY - r2 - 5, c2 = e3.pageX - o2 - 5;
              h2 && (l2 += r2 + 5, c2 -= 10), e3.clientX < a2.left + o2 + 5 && (c2 = e3.pageX + 5 + 2, h2 && (c2 += 10)), t3._tooltip.style.cssText = "top: " + l2 + "px; left: " + c2 + "px";
            }
          });
        }, e2.getElement = function() {
        ...
        return e2.init = function(t3) {
          ...
          var e3 = this;
          void 0 === t3 && (t3 = true);
          var i2 = w.getEventRegistry(), s2 = Object.keys;
          c(this.tooltip.getElement()), s2(i2).forEach(function(t4) {
            w.off(i2[t4].selector, t4, i2[t4].handler);
          }), this.emit("map:destroyed"), t3 && s2(this).forEach(function(t4) {
            try {
              delete e3[t4];
            } catch (t5) {
            }
