...
export default defineConfig({
    plugins: [
        laravel({
            input: [
                ...
                'node_modules/glightbox/dist/css/glightbox.min.css',
                'node_modules/gridjs/dist/theme/mermaid.min.css', // pastikan file ini ada di sini
    ...
    build: {
        outDir: 'public/build', // Pastikan output diarahkan ke folder yang benar di public
